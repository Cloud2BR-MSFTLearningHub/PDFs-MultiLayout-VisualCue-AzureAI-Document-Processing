...
The Terraform template provisions the Azure resources used by this solution, including Storage, Azure AI services, Cosmos DB, Key Vault, Application Insights, and the Function App.
...
For screenshots, parameter guidance, and the complete Terraform walkthrough, see the [canonical Terraform guide](https://github.com/Cloud2BR-MSFTLearningHub/PDFs-MultiLayout-VisualCue-AzureAI-Document-Processing/blob/main/terraform-infrastructure/README.md).